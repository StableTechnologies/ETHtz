...
This is the code that was used to deploy the current version of the ETHtz token on the Tezos blockchain at [KT1LN4LPSqTMS7Sd2CJw4bbDGRkMv2t68Fy9](https://arronax.io/tezos/mainnet/accounts/KT19at7rQUvyjxnZ2fBv7D9zc8rkyG7gAoU8). The script is based on [ConseilJS](https://github.com/Cryptonomic/ConseilJS) and was run with [Nautilus Cloud](https://nautilus.cloud) infrastructure.
